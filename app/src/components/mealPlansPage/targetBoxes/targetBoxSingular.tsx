...
export default function TargetBoxSingular({
  ...
  return (
    <>
      <div className="relative h-full p-4 pr-6 rounded-xl flex flex-col items-start justify-between bg-white border-2 border-solid border-lightgray w-full">
        {changeTargetFunction && (
          <img
        ...
        <img className="size-10 2xl:size-16" src={icon} alt="target icon" />
